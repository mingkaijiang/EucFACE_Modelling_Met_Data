prepare_GDAY_predicted_wet_data <- function() {
    ...
    ### output DF3
    write.table(head.list, "output/GDAY/EUC_met_WET_AMB_MDP_daily_2020_2069.csv",
                col.names=F, row.names=F, sep=",", append=F, quote = F)
    
    write.table(unit.list, "output/GDAY/EUC_met_WET_AMB_MDP_daily_2020_2069.csv",
                col.names=F, row.names=F, sep=",", append=T, quote = F)
    
    write.table(outname.list, "output/GDAY/EUC_met_WET_AMB_MDP_daily_2020_2069.csv",
                col.names=F, row.names=F, sep=",", append=T, quote = F)
    
    write.table(outDF3, "output/GDAY/EUC_met_WET_AMB_MDP_daily_2020_2069.csv",
                col.names=F, row.names=F, sep=",", append=T, quote = F)
    ...
    ### output DF5
    write.table(head.list, "output/GDAY/EUC_met_WET_AMB_HIP_daily_2020_2069.csv",
                col.names=F, row.names=F, sep=",", append=F, quote = F)
    
    write.table(unit.list, "output/GDAY/EUC_met_WET_AMB_HIP_daily_2020_2069.csv",
                col.names=F, row.names=F, sep=",", append=T, quote = F)
    
    write.table(outname.list, "output/GDAY/EUC_met_WET_AMB_HIP_daily_2020_2069.csv",
                col.names=F, row.names=F, sep=",", append=T, quote = F)
    
    write.table(outDF5, "output/GDAY/EUC_met_WET_AMB_HIP_daily_2020_2069.csv",
                col.names=F, row.names=F, sep=",", append=T, quote = F)
